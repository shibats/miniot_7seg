...
displayHexValue: function(hexvalue, bDecimalPoint) {
    var self = this;
    self.options.hexvalue = hexvalue;
    var segments = hexvalue & 0xff;
    self.jqSegments.children().each(function(index, element) {
        self._setSvgElementFill($(element), segments & (1 << index));
    });
